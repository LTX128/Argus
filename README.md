...
**Vous êtes le seul responsable de l'usage que vous faites de ce logiciel.** Le développeur décline toute responsabilité pour les dommages ou les problèmes légaux résultant d'une mauvaise utilisation. **Utilisez cet outil de manière éthique et responsable.**
